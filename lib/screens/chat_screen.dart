...
import 'package:healthpaddy/providers/chats_provider.dart';
import 'package:healthpaddy/providers/models_provider.dart';
import 'package:healthpaddy/services/assets.manager.dart';
import 'package:healthpaddy/services/services.dart';
import 'package:healthpaddy/widgets/chat_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 2,
        leading: Image.asset(
          AssetsManager.healthpaddyLogo,
          fit: BoxFit.contain,
        ),
        title: const Text("HealthPaddy"),
        actions: [
          IconButton(
            onPressed: () async {
